...
training_v = np.load('training_set/training_v.npy').reshape(-1, batch_size).astype(np.int32)
training_y = np.load('training_set/training_y.npy').reshape(-1, batch_size, l0.get_num_choices())
training_x = np.load('training_set/training_x.npy').reshape(-1, batch_size, l0.get_input_size())

testing_v = np.load('training_set/training_v.npy').astype(np.int32)
testing_y = np.load('training_set/training_y.npy')
testing_x = np.load('training_set/training_x.npy').reshape(-1, l0.get_input_size())
